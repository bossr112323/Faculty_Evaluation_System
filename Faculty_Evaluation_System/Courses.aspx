<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Courses.aspx.vb" Inherits="Faculty_Evaluation_System.Courses" %>
...
<head runat="server">
    ...
    <title>Manage Courses - Faculty Evaluation System</title>
    ...
    @media (max-width: 768px) {
        ...
        .add-course-form .col-md-5,
        .add-course-form .col-md-4,
        .add-course-form .col-md-2 {
            width: 100%;
            margin-bottom: 1rem;
        }
...
/* Adjust form layout for new field */
.add-course-form .row {
    align-items: flex-end;
}

@media (max-width: 768px) {
    .add-course-form .col-md-3 {
        width: 100%;
        margin-bottom: 1rem;
    }
}
    ...
    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userMenu">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <div class="list-group list-group-flush">
                ...
                <a href="Courses.aspx" class="list-group-item list-group-item-action active">
  ...
  <a href="Prints.aspx" class="list-group-item list-group-item-action">
      ...
      <span class="list-group-text">Reports</span>
        ...
        <div class="content" id="mainContent">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4 page-header">
                <h2 class="mb-0 page-title"><i class="bi bi-journal-bookmark me-2 gold-accent"></i>Manage Courses</h2>
            </div>

            <!-- Add Course Card -->
            <div class="card mb-4 course-card">
                <div class="card-header py-3">
                    <h5 class="m-0 fw-bold text-primary"><i class="bi bi-plus-circle me-2"></i>Add New Course</h5>
                </div>
                <div class="card-body">
                    <div class="row g-3 align-items-end add-course-form">
                        <div class="col-md-5">
                            <label class="form-label fw-semibold">Course Name</label>
                            <div class="input-group">
                                <span class="input-group-text"><i class="bi bi-journal"></i></span>
                                <asp:TextBox ID="txtCourseName" runat="server" CssClass="form-control  auto-capitalize" placeholder="Enter course name " />
                            </div>
                        </div>
                        <div class="col-md-2">
    <label class="form-label fw-semibold">Year Levels</label>
    <div class="input-group">
        <span class="input-group-text"><i class="bi bi-calendar-range"></i></span>
        <asp:DropDownList ID="ddlYearLevels" runat="server" CssClass="form-select">
            ...
            <asp:ListItem Value="4" Selected="True">4 Years</asp:ListItem>
            ...
            <div class="card course-card">
                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                    <h5 class="m-0 fw-bold text-primary"><i class="bi bi-list-ul me-2"></i>Courses List</h5>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <asp:GridView ID="gvCourses" runat="server" AutoGenerateColumns="False"
                            DataKeyNames="CourseID" AllowPaging="True" PageSize="10"
                            ...
                            <Columns>
                                <asp:BoundField DataField="CourseID" HeaderText="ID" ReadOnly="True" Visible="False" />

                                <asp:TemplateField>
                                    <HeaderTemplate>
                                        <i class="bi bi-journal me-2 text-primary"></i> Course Name
                                    </HeaderTemplate>
                                    <ItemTemplate>
                                        <%# Eval("CourseName") %>
                                    </ItemTemplate>
                                    <EditItemTemplate>
                                        <div class="input-group">
                                            <span class="input-group-text"><i class="bi bi-journal"></i></span>
                                            <asp:TextBox ID="txtEditCourseName" runat="server" 
                                                Text='<%# Bind("CourseName") %>' CssClass="form-control  auto-capitalize" />
                                        </div>
                                    </EditItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField>
    <HeaderTemplate>
        <i class="bi bi-calendar-range me-2 text-info"></i> Year Levels
    </HeaderTemplate>
    <ItemTemplate>
        <%# Eval("YearLevels") %> Year(s)
    </ItemTemplate>
    <EditItemTemplate>
        <div class="input-group">
            <span class="input-group-text"><i class="bi bi-calendar-range"></i></span>
            <asp:DropDownList ID="ddlEditYearLevels" runat="server" CssClass="form-select">
                <asp:ListItem Value="1">1 Year</asp:ListItem>
                <asp:ListItem Value="2">2 Years</asp:ListItem>
                <asp:ListItem Value="3">3 Years</asp:ListItem>
                ...
                <asp:ListItem Value="6">6 Years</asp:ListItem>
                                ...
                                <asp:TemplateField>
                                    <HeaderTemplate>
                                        <i class="bi bi-building-gear me-2 text-secondary"></i> Department
                                    </HeaderTemplate>
                                    <ItemTemplate>
                                        <%# Eval("DepartmentName") %>
                                    </ItemTemplate>
                                    <EditItemTemplate>
                                        <asp:DropDownList ID="ddlEditDepartments" runat="server" CssClass="form-select" />
                                    </EditItemTemplate>
                                </asp:TemplateField>
    ...
    <script>
        ...
        function updateSidebarBadges() {
            $.ajax({
                type: "POST",
                url: "Courses.aspx/GetSidebarBadgeCounts",
                data: "{}",
